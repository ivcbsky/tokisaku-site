!(function (t, e) {
  ...
  var s,
    ...
    n = function (t, e) {
      ((this.inlineSize = t), (this.blockSize = e), r(this));
    },
    o = (function () {
      function t(t, e, i, s) {
        return (
    ...
    c = function (t) {
      ...
      var i =
        null === (e = null == t ? void 0 : t.ownerDocument) || void 0 === e
          ? void 0
          : e.defaultView;
    ...
    d = /auto|scroll/,
    g = /^tb|vertical/,
    W = /msie|trident/i.test(l.navigator && l.navigator.userAgent),
    p = function (t) {
    ...
    v = function (t, e) {
      if ((void 0 === e && (e = !1), u.has(t) && !e)) return u.get(t);
      if (h(t)) return (u.set(t, C), C);
    ...
    S = 0,
    E = { attributes: !0, characterData: !0, childList: !0, subtree: !0 },
    K = [
      "resize",
      "load",
      "transitionend",
    ...
    J = (function () {
      ...
      return (
        (e.prototype.isActive = function () {
          var t,
            e = F(this.target, this.observedBox, !0);
          return (
            (t = this.target),
            a(t) ||
              (function (t) {
  ...
  function U(t) {
    return "function" == typeof window.structuredClone
  ...
  class X {
    ...
    static getCharacters = () => (null == T && Q(), U(T));
    static registerCharacter = (t, e) => {
      const i = U(e);
      let s = i.initialState.i;
      ((s = Math.min(0.5, Math.max(0, s))), (i.initialState.i = s), (T[t] = i));
    };
    constructor(t = {}) {
      (null == T && Q(),
        (this._options = U(G)),
    ...
    _updateLimit = (t) => {
      ...
      const i = t / 4,
        s = -i;
      this._limit = { maxR: e, maxY: i, minY: s };
    };
    _updateSize = (t) => {
      ...
      const e = (function (t, e, i = 2 * (window.devicePixelRatio || 1)) {
        ...
        return r ? (r.setTransform(1, 0, 0, 1, 0, 0), r.scale(i, i), r) : null;
      })(this._domCanvas, this._canvasSize);
      if (!e) throw new Error("Invalid canvas context");
    ...
    _updateDom = () => {
      ...
      ((t.className = "sakana-widget-wrapper"), (this._domWrapper = t));
    ...
    _calcCenterPoint = (t, e, i, s) => {
      const r = (Math.PI / 180) * t,
        n = Math.cos(r),
        o = Math.sin(r);
      return { nx: o * e + n * i - o * s, ny: n * e - n * s - o * i };
    };
    _draw = () => {
      const { r: t, y: e } = this._state,
        ...
        h = 1 * t;
      if (
        ((n.style.transform = `rotate(${t}deg) translateX(${h}px) translateY(${e}px)`),
    ...
    _onMouseDown = (t) => {
      (t.preventDefault(), (this._running = !1));
      const { pageY: e } = t,
        i = e;
      ((this._state.w = 0), (this._state.t = 0));
      const s = (t) => {
    ...
    _onTouchStart = (t) => {
      if ((t.preventDefault(), (this._running = !1), !t.touches[0])) return;
    ...
    _magicForce = () => {
      if (Math.random() < 0.1) {
        ...
        ((this._state.t = this._state.t + 150 * (Math.random() - 0.5)),
          (this._state.w = this._state.w + 200 * (Math.random() - 0.5)));
      (this._running ||
        ((this._running = !0), requestAnimationFrame(this._run)),
    ...
    triggerAutoMode = () => {
      ...
      (this._magicForceEnabled
        ? t.classList.add("sakana-widget-icon--rotate")
        : t.classList.remove("sakana-widget-icon--rotate"),
    ...
    setCharacter = (t) => {
      const e = T[t];
      if (!e) throw new Error(`invalid character ${t}`);
      return (
        (this._char = t),
        (this._image = e.image),
    ...
    nextCharacter = () => {
      const t = Object.keys(X.getCharacters()).sort(),
        ...
        i = t[(e + 1) % t.length];
      return (this.setCharacter(i), this);
    };
    _onResize = (t) => {
      let e = Math.min(t.width, t.height);
      ((e = Math.max(120, e)), this._updateSize(e), this._updateLimit(e));
    };
    mount = (t) => {
      let e;
      if (((e = "string" == typeof t ? document.querySelector(t) : t), !e))
        throw new Error("Invalid mounting element");
      const i = e.parentNode;
      if (!i) throw new Error("Invalid mounting element parent");
      ...
      return (
        s.appendChild(this._domWrapper),
        i.replaceChild(s, e),
        requestAnimationFrame(this._run),
        this
      );
    ...
    unmount = () => {
      ...
      if (!t) throw new Error("Invalid mounting element");
      return (t.removeChild(this._domWrapper), this);
    };
  }
  return X;
});
